...
import { Button, Card, CardActions, CardContent, ClickAwayListener, Fade, IconButton, Popper, Toolbar, Typography } from "@mui/material";
            ...
            <Box sx={{ display: 'flex' }}>
                ...
                <AppBar position="fixed" open={open}>
                    <Toolbar>
                        ...
                        <Popper open={accountOpen} anchorEl={anchorEl} placement='bottom-end' transition>
                            {({ TransitionProps }) => (
                ...
                <Drawer variant="permanent" open={open}>
                    ...
                    <List>
                        ...
                        { name: 'Buyer\'s Guide', link: '/guide', icon: <MenuBookIcon /> }].map((navItem, index) => (
                            <></>
                            // <ListItem key={navItem.link} component={RouterLink} to={navItem.link}>
                            ...
                            //             {navItem.icon}
                            //         </ListItemIcon>
                            //         <ListItemText primary={navItem.name} primaryTypographyProps={{
                            //             color: "inherit"
                            //         }} sx={{ opacity: open ? 1 : 0 }} />
                            //     </ListItemButton>
                            // </ListItem>
