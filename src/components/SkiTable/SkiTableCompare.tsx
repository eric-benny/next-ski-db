...
export const SkiTableCompare = ({ skis, skisLoading, height }: SkiTableProps) => {
    ...
    function removeCompareSki(idToRemove: string) {
        const newCompareSkis = compareSkis.filter((ski: Ski) => ski.id !== idToRemove)
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={3}>
                            <Button color='primary'
                                ...
                                variant="contained"
                                disabled={compareSkis.length > 0 ? false : true}>Compare</Button>
                        </Grid>
                        <Grid item xs sx={{
